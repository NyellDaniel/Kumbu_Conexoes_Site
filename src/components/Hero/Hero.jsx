...
const CARDS = [
  {
    ...
    text: 'Gerir projectos com excelência para criar impacto real e gerar valor duradouro.',
    icon: 'M13 10V3L4 14h7v7l9-11h-7z',
    color: '#2db54b',
  },
  {
    label: 'A nossa missão',
    text: 'Transformar desafios em oportunidades através de uma gestão de projectos eficiente e orientada a resultados.',
    icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
    color: '#f5a623',
  },
  {
    label: 'A nossa visão',
    text: 'Ser a referência em consultoria estratégica em Angola, reconhecida pelo impacto real que geramos nas empresas.',
    icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0zM2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z',
    color: '#5b6ef5',
  },
  {
    label: 'Os nossos valores',
    text: 'Compromisso, transparência, inovação e foco em resultados — os pilares que guiam cada projecto que gerimos.',
...
const HeroCardSlider = () => {
  ...
  const goTo = (idx) => {
    ...
    setVisible(false)                         // fade out suave

    setTimeout(() => {
      setCurrent(idx)
      setVisible(true)                        // fade in suave
